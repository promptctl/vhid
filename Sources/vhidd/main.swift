...
do {
    ...
    // Keyboard Setup Assistant row, which stays unmet until the answer is actually on
    // disk - so this is reported twice and swallowed nowhere. [LAW:no-silent-failure]
