...
/// questions to different readers. `vhid doctor` names its version to a reader who
/// installed vhid and has no clone of this repo, for whom `scripts/virtual-hid-driver
